...
export const WEAPONS: WeaponDef[] = [
  ...
  w(32, "Precision Coil Rifle", "Vaelith", "hitscan", VIEW.rifle, "gun", SPARK, { damage: 34, cooldown: 0.2, mag: 18, reserve: 72, spread: 0.004, range: 200, zoom: 44 }),
  w(33, "Sanguine Pulse SMG", "Sanguara", "hitscan", VIEW.smg, "gun", PULSE, { damage: 10, cooldown: 0.055, automatic: true, mag: 44, reserve: 176, spread: 0.022, range: 80 }),
  w(34, "Ankh Beam Lance", "Aelith", "beam", VIEW.beam, "gun", ANKH, { damage: 110, cooldown: 1.0, mag: 6, reserve: 18, unlock: "eryndra", range: 220 }),
  w(35, "Rune Caster Launcher", "Rynara", "projectile", VIEW.caster, "gun", RUNE, { damage: 70, cooldown: 0.78, mag: 4, reserve: 16 }),
  w(36, "Ember Sidearm", "Vaelith", "hitscan", VIEW.rifle, "gun", SPARK, { damage: 22, cooldown: 0.22, mag: 12, reserve: 60, spread: 0.012, range: 70 }),
  w(37, "Night Sniper", "Nyxara", "hitscan", VIEW.sniper, "gun", NEEDLE, { damage: 120, cooldown: 1.15, mag: 3, reserve: 15, spread: 0.02, range: 320, zoom: 18 }),
  w(38, "Blood Repeater", "Sanguara", "hitscan", VIEW.smg, "gun", PULSE, { damage: 16, cooldown: 0.09, automatic: true, mag: 28, reserve: 112 }),
  w(39, "Law Disruptor", "Rynara", "projectile", VIEW.caster, "gun", RUNE, { damage: 40, cooldown: 0.5, mag: 8, reserve: 32 }),
  w(40, "Crystal Carbine", "Rynara", "hitscan", VIEW.rifle, "gun", SPARK, { damage: 24, cooldown: 0.14, automatic: true, mag: 26, reserve: 104, spread: 0.01 }),
  w(41, "Wraith Pistol", "Nyxara", "hitscan", VIEW.rifle, "gun", SPARK, { damage: 18, cooldown: 0.18, mag: 10, reserve: 50, spread: 0.014, range: 60 }),
  w(42, "Sentinel Lance Gun", "Type VII", "rail", VIEW.rail, "gun", RAIL, { damage: 38, cooldown: 0.4, mag: 12, reserve: 48 }),
  ...
  w(50, "Night Bow", "Nyxara", "hitscan", VIEW.sniper, "exotic", NEEDLE, { damage: 64, cooldown: 0.7, mag: 1, reserve: 30, spread: 0.008, range: 160, zoom: 36 }),
  w(51, "Ember Greatbow", "Vaelith", "hitscan", VIEW.sniper, "exotic", NEEDLE, { damage: 84, cooldown: 0.95, mag: 1, reserve: 24, range: 200, zoom: 32 }),
