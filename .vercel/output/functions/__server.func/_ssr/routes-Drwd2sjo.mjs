...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-Drwd2sjo.js
...
function buildProfile(code) {
	...
	const ember = rgb(196 + Math.floor(rng() * 40), 18 + Math.floor(rng() * 36), 40 + Math.floor(rng() * 28));
	const fogMix = rng();
	const fogColor = rgb(6 + Math.floor(fogMix * 8), 2 + Math.floor(fogMix * 5), 12 + Math.floor(fogMix * 14));
...
var NAMES = [
	{
		...
		claim: "You reach into the flame. The flame reaches back. Spark Rifle is yours — every shot a fragment of the first word.",
		verse: [
	...
	},
	{
		...
		claim: "You walk the spiral while the runes rewrite which way is up. Law sits in your palms. Rune Caster is yours.",
		verse: [
	...
	},
	{
		...
		rune: "tide",
		zone: "Blood Canals",
		claim: "The rivers rise. The blood listens. Sanguine Pulse is yours — living red, compressed to a bolt.",
		verse: [
	...
	},
	{
		...
		claim: "The fifth Name burns into you. The Ankh Beam unlocks — her gift and her warning.",
		verse: [
	...
	},
	{
		...
		claim: "Night settles into your arms. After Nyxara nothing is ever fully bright again.",
		verse: [
	...
	},
	{
		...
		rune: "sovereign",
		zone: "Throne Heart",
		claim: "The six Names light in sequence. The light becomes absolute. Cycle complete. The Key is turned.",
		verse: [
...
var GATE_MOMENT = {
	...
	body: "The crimson gate opens. Eryndra waits beyond. Crossing is like stepping into a living throat.",
...
var CODEX_SECTIONS = [
	{
		...
		body: [
			"Type VI scouts are trained for edges, for the thin places where one reality bleeds into another. You had walked a hundred such thresholds. None prepared you for the one that opened without warning above the black salt flats. It did not look like a door. It looked like a wound that had learned to sing.",
			"Red light poured out in slow arterial pulses. The air tasted of iron and ozone and something older. Your sensors flooded with data that made no sense. A single repeating harmonic translated, against every safety protocol, as a voice: Come home.",
			"You stepped through because that is what scouts do. Because the alternative was to watch the bureaucracy bury it. Because part of you still dreamed in the old myths. The Threshold received you like a held breath."
		]
	},
	{
		heading: "The Open Palace Grounds",
		body: ["There are no corridors here. No loading screens. No polite sequence of rooms. The palace floats between realities the way a thought floats between one mind and another. You may walk any direction the moment you arrive. The only limit is the gate that seals the inner throne.", "North of the main staircase the crystal plain rises into a field of ember pylons. West, beyond a low ridge of black glass, lies an archive of floating hieroglyph stones. East, the canals begin: wide silent channels of liquid crimson. Skyward, platforms of dark stone hang without support, connected by bridges of frozen lightning."]
	},
	{
		heading: "Vaelith — First Flame",
		body: ["The pylons are older than the palace. When you approach, the air grows hot. Sparks leap and try to climb your arms. Taking the spark rune is not a button press. You must reach into the flame. The flame reaches back.", "For a moment you stand on a plain of ash under a sky the colour of fresh blood, watching a woman with hair of living fire speak the first word that ever meant I am. When the vision releases you, the Spark Rifle is yours: hitscan, precise, every shot a fragment of that first word."]
	},
	{
		heading: "Rynara — Weaver of Runes",
		body: ["The hieroglyph monoliths float in slow orbits around a central black stone that is a knot of pure law. To claim it you walk the spiral path while the runes attempt to rewrite your suit’s code and your sense of which way is up. Rynara’s voice is the softest of the six. She suggests. You learn to ignore the suggestions. The Rune Caster is the reward: slow, heavy, lobbed glyphs that detonate in wide burning circles of rewritten law."]
	},
	{
		heading: "Sanguara — Blood of the Cosmos",
		body: ["The red rivers are not water. They are the cooled and still-living blood of something that was once large enough to have veins the size of canyons. Claiming the tide rune requires you to stand while the rivers rise. The blood climbs your legs, your waist, your chest. It does not drown you. It listens. When the vision ends the Sanguine Pulse is yours: full-auto, compressed bolts of the same living red."]
	},
	{
		heading: "Nyxara — Night Ascendant",
		body: ["The western rise is a vertical maze of floating platforms connected by bridges of solidified lightning. Night is thicker here. The night rune waits at the highest platform, a single dark glyph that drinks light. Reaching it is a test of movement and nerve. After Nyxara nothing is ever fully bright again."]
	},
	{
		heading: "The Interior — Eryndra",
		body: ["Crossing the gate is like stepping into a living throat. The air is warmer. The walls pulse. The throne sits at the centre of a vast circular chamber — a complicated knot of black crystal and living red light. When the last construct falls the Eryndra rune descends and burns itself into you. The fifth pip fills. The Ankh Beam unlocks: her gift and her warning."]
	},
	{
		heading: "Aelith — Final Form",
		body: ["She does not appear all at once. First the light changes. The floating ankh-stones align. Then the throne unfolds. Tall. Elegant. Hair of pure white that moves as if underwater. Eyes that hold the same red as the storm. A gown that is part armour, part living rune-script, part the memory of every sacrifice that fed this place.", "This is Aelith the Crimson. Type VII. Sovereign of living runes. The palace that walks. The fight is not a simple exchange of damage. She teleports in bursts of red lightning. She calls down pillars of first-fire. She opens rifts that spill additional wraiths. When her health finally breaks she unfolds. The six Names light up in sequence. The light becomes absolute."]
	},
	{
		heading: "Arms of the Cycle",
		body: [
			"1 Spark Rifle (Vaelith) — Hitscan coil. High precision. Every shot a fragment of the first word.",
			"2 Rune Caster (Rynara) — Projectile launcher. Slow travel. Wide burst of rewritten law.",
			"3 Sanguine Pulse (Sanguara) — Full-auto. Compressed bolts of living red.",
			"4 Ankh Beam (Aelith) — Unlocks at Eryndra. Hold to charge. Release a lance of pure crimson.",
	...
	},
	{
		...
		body: ["The palace is still there. The storm still turns. You crossed a rift that should not exist. You walked the open grounds of a being that is also a place. The cycle is complete for this turn of the wheel. The next turn is already beginning somewhere in the red dark.", "Walk carefully, Type VI. The door remembers your name. And Aelith is patient. She has all the time in the world. And the world, in this place, is made of her."]
	}
];
...
/** Painted map: Threshold south (bottom), Vaelith north (top), Rynara west, Sanguara east. */
...
function drawSatNav(ctx, w, h, frame) {
	...
	if (atlas && atlas.complete && atlas.naturalWidth > 0) ctx.drawImage(atlas, 0, 0, w, h);
	else {
		ctx.fillStyle = "#140308";
		ctx.fillRect(0, 0, w, h);
	}
	ctx.restore();
	ctx.fillStyle = "rgba(8,0,2,0.16)";
	ctx.fillRect(0, 0, w, h);
	const pip = (x, z) => {
	...
	for (const mark of MAP_LANDMARKS) {
		...
		ctx.beginPath();
		ctx.arc(p.sx, p.sy, claimed ? 5 : 3.5, 0, Math.PI * 2);
		ctx.fill();
	}
...
function GameApp() {
	...
	const [loadP, setLoadP] = (0, import_react.useState)(0);
	(0, import_react.useEffect)(() => {
		...
		preloadArt(setLoadP).then(() => setBooted(true));
	}, []);
	if (!booted) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "relative grid h-dvh w-full place-items-center overflow-hidden bg-bg font-sans text-fg",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "w-64 text-center",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "font-display text-sm tracking-[0.3em] text-muted",
					children: "LOADING THE PALACE"
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "mt-2 font-mono text-xs tracking-widest text-subtle",
					children: [Math.round(loadP * 100), "%"]
				})
			]
		})
	});
...
function PlayView() {
	...
	(0, import_react.useEffect)(() => {
		...
		let dead = false;
		let game = null;
		import("./engine-D3-Kak67.mjs").then(({ CrimsonGame }) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: hud.scoped ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "size-3 rounded-full border-[1.5px] border-crimson shadow-[0_0_12px_#c41e3a]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					className: "mr-24 flex items-start gap-2 sm:mr-52",
...
function PulseMap() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "absolute top-[4.6rem] right-2 z-10 size-[6.6rem] sm:top-3 sm:right-3 sm:size-[13rem]",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("canvas", {
			ref,
			width: 256,
			height: 256,
			className: "absolute inset-[20%] h-[60%] w-[60%] rounded-full"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
...
function WeaponBag() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "relative w-[min(920px,96vw)] max-h-[90dvh] overflow-hidden rounded-md border border-border bg-surface",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "grid max-h-[55dvh] grid-cols-2 gap-2 overflow-y-auto p-3 sm:grid-cols-4",
					children: list.map((w) => {
...
function MobileControls() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute bottom-28 left-5 size-28 rounded-full border border-border/80 bg-surface/25" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TapBtn, {
							label: "TREE",
							onTap: () => window.__crimsonInput?.tree?.()
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TapBtn, {
							label: "MAP",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "TYPE VII MYTHIC SHOOTER · GALACTIC CYCLE"
					}),
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					...
					alt: "",
					decoding: "async",
					className: "h-28 w-full object-cover object-center opacity-90 sm:h-36"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
...
//#endregion
export { emptyActions as C, anyCode as S, INTERACT_GLYPH as _, GATE_MOMENT as a, STICK_SPRINT as b, CHARACTERS as c, buildProfile as d, mulberry32 as f, DEADZONE as g, ARM_FROM_DPAD as h, useGame as i, VIEW as l, streamSeed as m, modsFrom as n, NAMES as o, padCode as p, skillById as r, nameById as s, routes_exports as t, WEAPONS as u, KEY as v, radialDeadzone as w, PAD as y };
